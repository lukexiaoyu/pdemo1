// New Block - Updated September 5, 2023
function noop() { }
function run(fn) {
    return fn();
}
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t2 = claim_text(span_nodes, /*num*/ ctx[0]);
		...
		h() {
			attr(button0, "class", "svelte-jdjct3");
			attr(button1, "class", "svelte-jdjct3");
			attr(main, "class", "svelte-jdjct3");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*num*/ 1) set_data(t2, /*num*/ ctx[0]);
		},
		i: noop,
		o: noop,
		d(detaching) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('_copy' in $$props) $$invalidate(2, _copy = $$props._copy);
	};

	return [num, props, _copy, click_handler, click_handler_1];
}

class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 1, _copy: 2 });
	}
}
